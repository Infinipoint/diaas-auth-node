 ...
 * @since AM 5.5.0
 */
public class InfinipointDIaaSPlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(InfinipointDIaaSPlugin.currentVersion, 
				Collections.singletonList(InfinipointDIaaS.class));
	}
	...
	public String getPluginVersion() {
		return InfinipointDIaaSPlugin.currentVersion;
	}
}
